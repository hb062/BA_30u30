...
# Wie viele der Personen waren leitend im Verein tätig? / bei wie vielen Edges handelt es sich um eine leitende Funktion?
verein_bisaufn_leadership <- E(initiative_preentry1)$relationship == 13
sum(verein_bisaufn_leadership, na.rm=T)
# 55

# Wie viele davon waren leitend "nur" Mitglied tätig?
verein_bisaufn_membership <- E(initiative_preentry1)$relationship == 11
sum(verein_bisaufn_membership, na.rm=T)
